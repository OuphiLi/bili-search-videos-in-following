 ...
 **/
 ...
 var e_parent_down   =   null        // 新增按钮的父元素，用于确定位置
 ...
 function setButton(btn){
     // setTimeout不能嵌套
     e_parent_down = document.getElementsByClassName("follow-main")[0]
     btn.innerHTML = '下载列表'
     ...
     e_parent_down.insertBefore(btn, e_parent_down.childNodes[1])
 }
